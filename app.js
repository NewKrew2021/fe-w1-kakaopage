...
const day_top_mainData = fs.readFileSync('./public/data/daytopmain.json');
...
const day_top_mainJSON = JSON.parse(day_top_mainData);
...
app.get('/', function(req, res){
  res.render('index', { home_slide, day_top, day_top_main,
    day_expect, homeBanner, home_top, day_slide });
})
app.listen(port, () => {
